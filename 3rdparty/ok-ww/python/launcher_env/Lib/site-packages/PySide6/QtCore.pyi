...
class Property(object):
    ...
    def __call__(self, func: typing.Callable) -> PySide6.QtCore.Property: ...
    def deleter(self, fdel: typing.Callable) -> PySide6.QtCore.Property: ...
    def getter(self, fget: typing.Callable) -> PySide6.QtCore.Property: ...
    def read(self, fget: typing.Callable) -> PySide6.QtCore.Property: ...
    def setter(self, fset: typing.Callable) -> PySide6.QtCore.Property: ...
    def write(self, fset: typing.Callable) -> PySide6.QtCore.Property: ...


class PyClassProperty(property):

    @classmethod
    def __init__(cls, fget: typing.Callable[[typing.Any], typing.Any] | None= ..., fset: typing.Callable[[typing.Any, typing.Any], NoneType] | None= ..., fdel: typing.Callable[[typing.Any], NoneType] | None= ..., doc: str | None= ...) -> None: ...
...
class QByteArray(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, arg__1: bytes | bytearray | memoryview) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def __add__(self, rhs: bytes | bytearray | memoryview) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def __add__(self, s: str) -> str: ...
    @typing.overload
    def __add__(self, a2: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def __add__(self, arg__1: bytes | bytearray | memoryview) -> None: ...
    @typing.overload
    def __add__(self, rhs: int) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def __add__(self, rhs: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    ...
    @typing.overload
    def indexOf(self, bv: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, from_: int = ...) -> int: ...
    @typing.overload
...
class QByteArrayMatcher(Shiboken.Object):
    ...
    def __copy__() -> None: ...
    @typing.overload
    def indexIn(self, str: bytes | bytearray | memoryview, len: int, from_: int = ...) -> int: ...
    @typing.overload
    def indexIn(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, from_: int = ...) -> int: ...
...
class QCoreApplication(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def requestPermission(self, permission: PySide6.QtCore.QMicrophonePermission, context: PySide6.QtCore.QObject, functor: typing.Callable) -> None: ...
    @typing.overload
    def requestPermission(self, permission: PySide6.QtCore.QCalendarPermission, context: PySide6.QtCore.QObject, functor: typing.Callable) -> None: ...
    @typing.overload
    def requestPermission(self, permission: PySide6.QtCore.QContactsPermission, context: PySide6.QtCore.QObject, functor: typing.Callable) -> None: ...
    @typing.overload
    def requestPermission(self, permission: PySide6.QtCore.QLocationPermission, context: PySide6.QtCore.QObject, functor: typing.Callable) -> None: ...
    @typing.overload
    def requestPermission(self, permission: PySide6.QtCore.QCameraPermission, context: PySide6.QtCore.QObject, functor: typing.Callable) -> None: ...
    @typing.overload
    def requestPermission(self, permission: PySide6.QtCore.QBluetoothPermission, context: PySide6.QtCore.QObject, functor: typing.Callable) -> None: ...
    ...
    @staticmethod
    def sendPostedEvents(receiver: PySide6.QtCore.QObject | None= ..., event_type: int = ...) -> None: ...
    @staticmethod
...
class QItemSelection(Shiboken.Object):
    ...
    @staticmethod
    def __copy__() -> None: ...
    def __iadd__(self, l: typing.Sequence[PySide6.QtCore.QItemSelectionRange]) -> typing.List[PySide6.QtCore.QItemSelectionRange]: ...
...
class QItemSelectionModel(PySide6.QtCore.QObject):
    ...
    def selectedColumns(self, row: int = ...) -> typing.List[PySide6.QtCore.QModelIndex]: ...
    def selectedIndexes(self) -> typing.List[PySide6.QtCore.QModelIndex]: ...
    def selectedRows(self, column: int = ...) -> typing.List[PySide6.QtCore.QModelIndex]: ...
...
class QLibrary(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, fileName: str, verNum: int, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, fileName: str, version: str, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QObject(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, context: PySide6.QtCore.QObject, functor: typing.Callable, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, functor: typing.Callable, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    @typing.overload
    ...
    @typing.overload
    def connect(self, signal: bytes | bytearray | memoryview, functor: typing.Callable, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    def connectNotify(self, signal: PySide6.QtCore.QMetaMethod) -> None: ...
    def customEvent(self, event: PySide6.QtCore.QEvent) -> None: ...
    def deleteLater(self) -> None: ...
    @typing.overload    # type: ignore[misc]
    def disconnect(self, signal: bytes | bytearray | memoryview, functor: typing.Callable) -> bool: ...
    @typing.overload
    @staticmethod
    def disconnect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, functor: typing.Callable) -> bool: ...
    @typing.overload
    ...
    def emit(self, arg__1: bytes | bytearray | memoryview, *args: None) -> bool: ...
    def event(self, event: PySide6.QtCore.QEvent) -> bool: ...
...
class QPropertyAnimation(PySide6.QtCore.QVariantAnimation):
    ...
    @typing.overload
    def __init__(self, target: PySide6.QtCore.QObject, propertyName: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QRectF(Shiboken.Object):
    ...
    @typing.overload
    def __add__(self, rhs: PySide6.QtCore.QMarginsF | PySide6.QtCore.QMargins) -> PySide6.QtCore.QRectF: ...
...
class QSystemSemaphore(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, key: PySide6.QtCore.QNativeIpcKey | str, initialValue: int = ..., arg__3: PySide6.QtCore.QSystemSemaphore.AccessMode = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setNativeKey(self, key: PySide6.QtCore.QNativeIpcKey | str, initialValue: int = ..., arg__3: PySide6.QtCore.QSystemSemaphore.AccessMode = ...) -> None: ...
    @typing.overload
...
class QTextBoundaryFinder(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, type: PySide6.QtCore.QTextBoundaryFinder.BoundaryType, str: str, buffer: bytes | bytearray | memoryview | None= ..., bufferSize: int = ...) -> None: ...
    @typing.overload
...
class QTextStream(PySide6.QtCore.QIODeviceBase):
    ...
    def readLineInto(self, maxlen: int = ...) -> typing.Tuple[bool, str]: ...
...
class QThreadPool(PySide6.QtCore.QObject):
    ...
    def stackSize(self) -> int: ...
    @typing.overload
    def start(self, arg__1: typing.Callable, priority: int = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def tryStart(self, arg__1: typing.Callable) -> bool: ...
...
class QTimeLine(PySide6.QtCore.QObject):
    ...
    def __init__(self, duration: int = ..., parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QTimer(PySide6.QtCore.QObject):
    ...
    @typing.overload
    @staticmethod
    def singleShot(msec: int, functor: typing.Callable) -> None: ...
    @typing.overload
    @staticmethod
    def singleShot(msec: int, receiver: PySide6.QtCore.QObject, member: bytes | bytearray | memoryview) -> None: ...
    @typing.overload
    @staticmethod
    def singleShot(msec: int, context: PySide6.QtCore.QObject, functor: typing.Callable) -> None: ...
    @typing.overload
    def start(self) -> None: ...
    @typing.overload
...
def qCCritical(arg__1: object, arg__2: bytes | bytearray | memoryview) -> None: ...
def qCDebug(arg__1: object, arg__2: bytes | bytearray | memoryview) -> None: ...
def qCInfo(arg__1: object, arg__2: bytes | bytearray | memoryview) -> None: ...
def qCWarning(arg__1: object, arg__2: bytes | bytearray | memoryview) -> None: ...
@typing.overload
