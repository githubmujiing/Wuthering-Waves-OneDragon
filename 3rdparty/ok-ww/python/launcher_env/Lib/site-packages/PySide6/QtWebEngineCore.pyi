...
class QWebEngineCookieStore(PySide6.QtCore.QObject):
    ...
    def setCookieFilter(self, filterCallback: typing.Callable) -> None: ...
...
class QWebEngineFrame(Shiboken.Object):
    ...
    @typing.overload
    def printToPdf(self, resultCallback: typing.Callable) -> None: ...
    @typing.overload
    def runJavaScript(self, scriptSource: str, worldId: int, resultCallback: typing.Callable = ...) -> None: ...
    @typing.overload
    def runJavaScript(self, scriptSource: str, resultCallback: typing.Callable) -> None: ...
...
class QWebEnginePage(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def findText(self, subString: str, options: PySide6.QtWebEngineCore.QWebEnginePage.FindFlag, resultCallback: typing.Callable) -> None: ...
    ...
    @typing.overload
    def printToPdf(self, resultCallback: typing.Callable, pageLayout: PySide6.QtGui.QPageLayout = ..., ranges: PySide6.QtGui.QPageRanges = ...) -> None: ...
    @typing.overload
    ...
    def title(self) -> str: ...
    def toHtml(self, resultCallback: typing.Callable) -> None: ...
    def toPlainText(self, resultCallback: typing.Callable) -> None: ...
...
class QWebEngineProfile(PySide6.QtCore.QObject):
    ...
    def setNotificationPresenter(self, notificationPresenter: typing.Callable) -> None: ...
