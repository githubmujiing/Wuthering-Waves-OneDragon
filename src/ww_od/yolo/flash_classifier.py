...
from ww_od.config.yolo_config import ZZZ_MODEL_DOWNLOAD_URL
from ww_od.yolo import onnx_utils
from ww_od.yolo.onnx_model_loader import OnnxModelLoader
...
class FlashClassifier(OnnxModelLoader):
...
if __name__ == '__main__':
    FlashClassifier(model_parent_dir_path=os_utils.get_path_under_work_dir('assets', 'models', 'yolo'),
                    gpu=True)