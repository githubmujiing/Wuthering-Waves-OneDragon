...
class WContext(OneDragonContext):
    ...
    def __init__(self, for_installer: bool = False):
        ...
        # 尝试删除from zzz_od.context.hollow_context import HollowContext
    ...
    def load_instance_config(self) -> None:
        ...
        from zzz_od.application.Arrange_radio.Arrange_radio_run_record import ArrangeRadioRunRecord
        ...
        # 尝试删除from zzz_od.application.hollow_zero.hollow_zero_run_record import HollowZeroRunRecord
        # 尝试删除from zzz_od.application.life_on_line.life_on_line_config import LifeOnLineConfig
        # 尝试删除from zzz_od.application.life_on_line.life_on_line_run_record import LifeOnLineRunRecord
        ...
        # 尝试删除from zzz_od.application.random_play.random_play_run_record import RandomPlayRunRecord
        # 尝试删除from zzz_od.application.scratch_card.scratch_card_run_record import ScratchCardRunRecord
        from zzz_od.config.game_config import GameConfig
        # 尝试删除from zzz_od.hollow_zero.hollow_zero_challenge_config import HollowZeroChallengeConfig
        from zzz_od.application.redemption_code.redemption_code_run_record import RedemptionCodeRunRecord
        # 尝试删除from zzz_od.application.commission_assistant.commission_assistant_config import CommissionAssistantConfig
        ...
        # 尝试删除from zzz_od.application.random_play.random_play_config import RandomPlayConfig
